...
const BUNDLES: ShopCatalogItem[] = [
  {
    ...
    imageUrl: ROOT_CAMPAIGN_IMAGES[0]?.url || SHOP_PLACEHOLDER_IMAGE,
    images: [ROOT_CAMPAIGN_IMAGES[0], DESK_MAT_IMAGES[1], MACBOOK_CASE_IMAGES[1], QUAKE_CHARGER_IMAGES[1]].filter(Boolean),
    tab: "workspace",
    shippingClass: "pod",
  ...
  },
  {
    ...
    ratingCount: 21,
    ships: "Native unlock offer. Ships on the same physical-product timeline after checkout.",
    imageUrl: ROOT_CAMPAIGN_IMAGES[1]?.url || SHOP_PLACEHOLDER_IMAGE,
    images: [ROOT_CAMPAIGN_IMAGES[1], JABBA_SPEAKER_IMAGES[1], ESSOS_EARBUD_IMAGES[1], AIRPODS_CASE_IMAGES[1]].filter(Boolean),
    tab: "audio",
    shippingClass: "pod",
    provider: "Quantura bundle offer",
    providerScore: 10,
  ...
  },
  {
    ...
    ratingCount: 18,
    ships: "Native unlock offer. Ships on the same physical-product timeline after checkout.",
    imageUrl: ROOT_CAMPAIGN_IMAGES[2]?.url || SHOP_PLACEHOLDER_IMAGE,
    images: [ROOT_CAMPAIGN_IMAGES[2], WATCH_BAND_IMAGES[1], AIRPODS_MAX_CASE_IMAGES[1], MACBOOK_CASE_IMAGES[2]].filter(Boolean),
    tab: "wearables",
    shippingClass: "pod",
    provider: "Quantura bundle offer",
    providerScore: 10,
