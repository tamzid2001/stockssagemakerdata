...
export function addPerpsSupportOpenapi(document:any, origin:string) {
  ...
  Object.assign(document.components.schemas.EnsembleForecastRequest.allOf[1].properties, {
    analysis_mode:{type:"string",enum:["forecast"],default:"forecast",description:"New jobs provide forecast quantiles without buy/sell classifications. Historical saved jobs remain readable."},
  });
}
