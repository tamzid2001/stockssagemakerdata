...
| X_BEARER_TOKEN      | TWITTER_BEARER_TOKEN | Mapped in code                |
| X_CLIENT_KEY        | TWITTER_API_KEY     | Mapped in code                 |
| X_CLIENT_SECRET     | TWITTER_API_SECRET  | Mapped in code                 |
| X_CLIENT_SECRET_ID  | TWITTER_API_SECRET  | Fallback in code               |
| X_SECRET_KEY        | TWITTER_API_SECRET  | Mapped in code                 |
...
- LINKEDIN_CLIENT_ID, LINKEDIN_PRIMARY_SECRET → OAuth (not yet used)
