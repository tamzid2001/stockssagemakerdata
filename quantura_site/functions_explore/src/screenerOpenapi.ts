...
export function addScreenerOpenapi(document:any):void {
  ...
  document.components.schemas.ScreenerAlertFilters={type:"object",additionalProperties:false,properties:{
    ...
    minMarketCap:{type:["number","null"],minimum:0,default:null},maxMarketCap:{type:["number","null"],minimum:0,default:null},signal:{type:"string",enum:["all","buy","sell","neutral","unavailable","cutoff_buy"],default:"all",description:"cutoff_buy requires the immutable last model-input close > first predicted P99. Other signals retain current-quote P10/P90 semantics."},signalChanged:{type:"boolean",default:false},
