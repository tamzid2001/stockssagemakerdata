...
if [[ -z "${GCLOUD_SET_SECRETS:-}" ]]; then
  ...
  add_secret_binding "STRIPE_SECRET_KEY" "STRIPE_SECRET_KEY" "STRIPE_PRIVATE_KEY" || true
  add_secret_binding "STRIPE_PRIVATE_KEY" "STRIPE_PRIVATE_KEY" "STRIPE_SECRET_KEY" || true
  add_secret_binding "STRIPE_WEBHOOK_SECRET" "STRIPE_WEBHOOK_SECRET" "STRIPE_WEBHOOK_SECRET_CONNECT" || true
  add_secret_binding "STRIPE_WEBHOOK_SECRET_CONNECT" "STRIPE_WEBHOOK_SECRET_CONNECT" "STRIPE_WEBHOOK_SECRET" || true
