...
export function addPerpsSupportOpenapi(document:any, origin:string) {
  ...
  Object.assign(document.components.schemas.EnsembleForecastRequest.allOf[1].properties, {
    analysis_mode:{type:"string",enum:["forecast","recent_signal_search"],default:"forecast",description:"recent_signal_search walks recent cutoffs backward without future leakage until the withheld next close is below P10 or above P90."},
    search_max_cutoffs:{type:"integer",minimum:1,maximum:30,default:20,description:"Bounded cutoff attempts for recent_signal_search. That mode requires a seven-period forecast with P10/P50/P90."},
  });
}
