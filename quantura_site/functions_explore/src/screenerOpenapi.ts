...
export function addScreenerOpenapi(document:any):void {
  ...
  document.components.schemas.ScreenerAlertFilters={type:"object",additionalProperties:false,properties:{
    ...
    minMarketCap:{type:["number","null"],minimum:0,default:null},maxMarketCap:{type:["number","null"],minimum:0,default:null},signal:{type:"string",enum:["all","buy"],default:"all",description:"Buy requires the latest completed daily input close > first future P99. Target: final P99 of seven future trading sessions."},signalChanged:{type:"boolean",default:false},
