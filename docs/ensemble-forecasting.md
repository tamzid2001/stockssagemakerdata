...
| `toto` | `Datadog/Toto-2.0-4m` by default; larger approved variants selectable | Native P10–P90 in 0.10 steps; interpolation only inside that interval; at least 32 genuine observations | Auto |
